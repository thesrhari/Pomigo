...
import { TimerStylesTabSkeleton } from "./TimerStylesTabSkeleton";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {isLoading
          ? Array.from({ length: timerStyleOptions.length }).map((_, index) => (
              <TimerStylesTabSkeleton key={index} />
            ))
                      ...
                      {option.id === "digital" && (
                        <div className="text-center space-y-2">
                          ...
                          <div className="text-sm text-muted-foreground/80">
                            Studying:{" "}
                            <span className="text-primary/80">Math</span>
                          </div>
                        </div>
                      )}
                      {option.id === "ring" && (
